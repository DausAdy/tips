...
discussions-to: https://github.com/tronprotocol/tips/issues/829
status: Last Call
...
![zkML Suggested Workflow](https://github.com/yanghang8612/tips/blob/trc-7007/assets/trc-7007/workflow.png?raw=true)
...
- AIGC-NFT smart contract - contract compliant with this proposal, with full [TRC-721](https://github.com/tronprotocol/tips/blob/master/tip-721.md) functionalities
...
**Every compliant contract must implement the `ITRC7007`, [`TRC721`](https://github.com/tronprotocol/tips/blob/master/tip-721.md), and [`TRC165`](https://github.com/tronprotocol/tips/blob/master/tip-165.md) interfaces.**

The verifiable AIGC-NFT standard includes the following interfaces:

`ITRC7007`: Defines an `addAigcData` function and an `AigcData` event for adding AIGC data to AIGC-NFTs. Defines a `verify` function to check the validity of the combination of prompt and aigcData using zkML/opML techniques.
 ...
 * Note: the TRC-165 identifier for this interface is 0x702c55a6.
 */
...
The **enumeration extension** is OPTIONAL for [TRC-7007](./829) smart contracts. This allows your contract to publish its full list of mapping between `tokenId` and `prompt` and make them discoverable.
 ...
 * Note: the TRC-165 identifier for this interface is 0xfa1a557a.
 */
...
The **updatable extension** is OPTIONAL for [TRC-7007](./829) smart contracts. This allows your contract to update a token's `aigcData` in the case of opML, where `aigcData` content might change over the challenge period.
 ...
 * Note: the TRC-165 identifier for this interface is 0x3f37dce2.
 */
...
### TRC-7007 Metadata JSON Schema for reference
...
This standard is backward compatible with the [TRC-721](https://github.com/tronprotocol/tips/blob/master/tip-721.md) as it extends the existing functionality with new interfaces.

## Test Cases

The reference implementation includes sample implementations of the [TRC-7007](./829) interfaces under `contracts/` and corresponding unit tests under `test/`. This repo can be used to test the functionality of the proposed interfaces and metadata schema.

## Reference Implementation

- TRC-7007 for [zkML](https://github.com/yanghang8612/tips/blob/trc-7007/assets/trc-7007/contracts/TRC7007Zkml.sol) and [opML](https://github.com/yanghang8612/tips/blob/trc-7007/assets/trc-7007/contracts/TRC7007Opml.sol)
- [TRC-7007 Enumerable Extension](https://github.com/yanghang8612/tips/blob/trc-7007/assets/trc-7007/contracts/TRC7007Enumerable.sol)
